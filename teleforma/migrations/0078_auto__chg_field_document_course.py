...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teleforma_document', 'course_id', self.gf('telemeta.models.core.ForeignKey')(null=True, to=orm['teleforma.Course']))
        # Removing M2M table for field doc_correct on 'Seminar'
        db.delete_table('teleforma_seminar_doc_correct')

        # Removing M2M table for field doc_2 on 'Seminar'
        db.delete_table('teleforma_seminar_doc_2')

        # Removing M2M table for field doc_1 on 'Seminar'
        db.delete_table('teleforma_seminar_doc_1')

        # Adding M2M table for field docs_1 on 'Seminar'
        db.create_table('teleforma_seminar_docs_1', (
        ...
        db.create_unique('teleforma_seminar_docs_1', ['seminar_id', 'document_id'])

        # Adding M2M table for field docs_2 on 'Seminar'
        db.create_table('teleforma_seminar_docs_2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('document', models.ForeignKey(orm['teleforma.document'], null=False))
        ))
        db.create_unique('teleforma_seminar_docs_2', ['seminar_id', 'document_id'])

        # Adding M2M table for field docs_correct on 'Seminar'
        db.create_table('teleforma_seminar_docs_correct', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('document', models.ForeignKey(orm['teleforma.document'], null=False))
        ))
        db.create_unique('teleforma_seminar_docs_correct', ['seminar_id', 'document_id'])

    def backwards(self, orm):

        # Changing field 'Document.course'
        db.alter_column('teleforma_document', 'course_id', self.gf('telemeta.models.core.ForeignKey')(on_delete=models.SET_NULL, to=orm['teleforma.Course'], null=True))
        # Adding M2M table for field doc_correct on 'Seminar'
        db.create_table('teleforma_seminar_doc_correct', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('document', models.ForeignKey(orm['teleforma.document'], null=False))
        ))
        db.create_unique('teleforma_seminar_doc_correct', ['seminar_id', 'document_id'])

        # Adding M2M table for field doc_2 on 'Seminar'
        db.create_table('teleforma_seminar_doc_2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('document', models.ForeignKey(orm['teleforma.document'], null=False))
        ))
        db.create_unique('teleforma_seminar_doc_2', ['seminar_id', 'document_id'])

        # Adding M2M table for field doc_1 on 'Seminar'
        db.create_table('teleforma_seminar_doc_1', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('document', models.ForeignKey(orm['teleforma.document'], null=False))
        ))
        db.create_unique('teleforma_seminar_doc_1', ['seminar_id', 'document_id'])

        # Removing M2M table for field docs_1 on 'Seminar'
        db.delete_table('teleforma_seminar_docs_1')

        # Removing M2M table for field docs_2 on 'Seminar'
        db.delete_table('teleforma_seminar_docs_2')

        # Removing M2M table for field docs_correct on 'Seminar'
        db.delete_table('teleforma_seminar_docs_correct')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.document': {
            ...
            'course': ('telemeta.models.core.ForeignKey', [], {'default': 'None', 'related_name': "'document'", 'null': 'True', 'blank': 'True', 'to': "orm['teleforma.Course']"}),
        ...
        'teleforma.evaluation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'seminar': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evaluation'", 'to': "orm['teleforma.Seminar']"}),
        ...
        'teleforma.seminar': {
            ...
            'docs_1': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doc1'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Document']"}),
            'docs_2': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doc2'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Document']"}),
            'docs_correct': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doccorrect'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Document']"}),
            ...
            'media': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_media'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.MediaPackage']"}),
        ...
        'teleforma.seminarrevision': {
            'Meta': {'object_name': 'SeminarRevision', 'db_table': "'teleforma_seminar_revisions'"},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'progress': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'seminar': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'seminar_revision'", 'to': "orm['teleforma.Seminar']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'seminar_revision'", 'to': "orm['auth.User']"})
        },
        ...
        'teleforma.testimonial': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'testimonial'", 'null': 'True', 'to': "orm['teleforma.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rank': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
