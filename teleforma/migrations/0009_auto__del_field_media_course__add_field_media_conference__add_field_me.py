...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('teleforma_media', 'course_id')

        # Adding field 'Media.conference'
        db.add_column('teleforma_media', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='media', null=True, to=orm['teleforma.Conference']),
                      keep_default=False)

        # Adding field 'Media.is_live'
        db.add_column('teleforma_media', 'is_live',
    ...
    def backwards(self, orm):
        ...
        db.add_column('teleforma_media', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='media', to=orm['teleforma.Course']),
                      keep_default=False)

        # Deleting field 'Media.conference'
        db.delete_column('teleforma_media', 'conference_id')

        # Deleting field 'Media.is_live'
        db.delete_column('teleforma_media', 'is_live')


        # Changing field 'Media.item'
        db.alter_column('teleforma_media', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['telemeta.MediaItem']))
    models = {
        'auth.group': {
