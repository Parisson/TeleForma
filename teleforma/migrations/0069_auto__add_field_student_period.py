...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teleforma_student', 'period',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='student', on_delete=models.SET_NULL, default=None, to=orm['teleforma.Period'], blank=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 9, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
