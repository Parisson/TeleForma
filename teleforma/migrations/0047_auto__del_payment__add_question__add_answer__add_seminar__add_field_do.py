...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('teleforma_payment')

        # Adding model 'Question'
        db.create_table('teleforma_question', (
            ...
            ('min_nchar', self.gf('django.db.models.fields.IntegerField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('teleforma', ['Question'])
        ...
        db.send_create_signal('teleforma', ['Answer'])

        # Adding model 'Seminar'
        db.create_table('teleforma_seminar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar', to=orm['teleforma.Course'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('price', self.gf('django.db.models.fields.FloatField')()),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('rank', self.gf('django.db.models.fields.IntegerField')()),
            ('doc_1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seminar_doc1', null=True, to=orm['teleforma.Document'])),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seminar', null=True, to=orm['teleforma.Media'])),
            ('doc_2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seminar_doc2', null=True, to=orm['teleforma.Document'])),
            ('doc_correct', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seminar_doccorrect', null=True, to=orm['teleforma.Document'])),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('duration', self.gf('telemeta.models.core.DurationField')(default='0', blank=True)),
        ))
        db.send_create_signal('teleforma', ['Seminar'])

        # Adding M2M table for field suscribers on 'Seminar'
        db.create_table('teleforma_seminar_suscribers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('teleforma_seminar_suscribers', ['seminar_id', 'user_id'])

        # Adding field 'Document.weight'
        db.add_column('teleforma_document', 'weight',
        ...
        # Adding field 'Media.weight'
        db.add_column('teleforma_media', 'weight',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
        ...
        # Changing field 'Conference.comment'
        db.alter_column('teleforma_conference', 'comment', self.gf('teleforma.fields.ShortTextField')(max_length=255))
    def backwards(self, orm):
        # Adding model 'Payment'
        db.create_table('teleforma_payment', (
            ('date_added', self.gf('telemeta.models.core.DateTimeField')(default=None, auto_now_add=True, null=True, blank=True)),
            ('amount', self.gf('telemeta.models.core.FloatField')(default=0, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('telemeta.models.core.ForeignKey')(related_name='payment', to=orm['teleforma.Student'])),
        ))
        db.send_create_signal('teleforma', ['Payment'])

        # Deleting model 'Question'
        db.delete_table('teleforma_question')

        # Deleting model 'Answer'
        db.delete_table('teleforma_answer')

        # Deleting model 'Seminar'
        db.delete_table('teleforma_seminar')

        # Removing M2M table for field suscribers on 'Seminar'
        db.delete_table('teleforma_seminar_suscribers')

        # Deleting field 'Document.weight'
        db.delete_column('teleforma_document', 'weight')


        # Changing field 'Document.mime_type'
        db.alter_column('teleforma_document', 'mime_type', self.gf('telemeta.models.core.CharField')(max_length=250))
        # Deleting field 'Media.weight'
        db.delete_column('teleforma_media', 'weight')


        # Changing field 'Media.mime_type'
        db.alter_column('teleforma_media', 'mime_type', self.gf('telemeta.models.core.CharField')(max_length=250))

        # Changing field 'Conference.comment'
        db.alter_column('teleforma_conference', 'comment', self.gf('teleforma.models.ShortTextField')(max_length=255))
    models = {
        'auth.group': {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
