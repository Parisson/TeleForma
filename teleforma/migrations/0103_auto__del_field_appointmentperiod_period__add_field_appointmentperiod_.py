...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppointmentPeriod.period'
        db.delete_column('teleforma_appointment_period', 'period_id')

        # Adding field 'AppointmentPeriod.enable_appointment'
        db.add_column('teleforma_appointment_period', 'enable_appointment',
        ...
        # Adding field 'AppointmentPeriod.cancel_delay'
        db.add_column('teleforma_appointment_period', 'cancel_delay',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'AppointmentPeriod.appointment_mail_text'
        db.add_column('teleforma_appointment_period', 'appointment_mail_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AppointmentPeriod.appointment_slot_size'
        db.add_column('teleforma_appointment_period', 'appointment_slot_size',
                      self.gf('django.db.models.fields.IntegerField')(default=40),
                      keep_default=False)

        # Adding M2M table for field periods on 'AppointmentPeriod'
        m2m_table_name = db.shorten_name('teleforma_appointment_period_periods')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('appointmentperiod', models.ForeignKey(orm['teleforma.appointmentperiod'], null=False)),
            ('period', models.ForeignKey(orm['teleforma.period'], null=False))
        ))
        db.create_unique(m2m_table_name, ['appointmentperiod_id', 'period_id'])

        # Deleting field 'Period.enable_appointment'
        db.delete_column('teleforma_period', 'enable_appointment')

        # Deleting field 'Period.book_delay'
        db.delete_column('teleforma_period', 'book_delay')

        # Deleting field 'Period.cancel_delay'
        db.delete_column('teleforma_period', 'cancel_delay')

        # Deleting field 'Period.appointment_mail_text'
        db.delete_column('teleforma_period', 'appointment_mail_text')

        # Deleting field 'Period.appointment_slot_size'
        db.delete_column('teleforma_period', 'appointment_slot_size')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AppointmentPeriod.period'
        raise RuntimeError("Cannot reverse this migration. 'AppointmentPeriod.period' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AppointmentPeriod.period'
        db.add_column('teleforma_appointment_period', 'period',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='appointment_periods', to=orm['teleforma.Period']),
                      keep_default=False)

        # Deleting field 'AppointmentPeriod.enable_appointment'
        db.delete_column('teleforma_appointment_period', 'enable_appointment')

        # Deleting field 'AppointmentPeriod.book_delay'
        db.delete_column('teleforma_appointment_period', 'book_delay')

        # Deleting field 'AppointmentPeriod.cancel_delay'
        db.delete_column('teleforma_appointment_period', 'cancel_delay')

        # Deleting field 'AppointmentPeriod.appointment_mail_text'
        db.delete_column('teleforma_appointment_period', 'appointment_mail_text')

        # Deleting field 'AppointmentPeriod.appointment_slot_size'
        db.delete_column('teleforma_appointment_period', 'appointment_slot_size')

        # Removing M2M table for field periods on 'AppointmentPeriod'
        db.delete_table(db.shorten_name('teleforma_appointment_period_periods'))

        # Adding field 'Period.enable_appointment'
        db.add_column('teleforma_period', 'enable_appointment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Period.book_delay'
        db.add_column('teleforma_period', 'book_delay',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Period.cancel_delay'
        db.add_column('teleforma_period', 'cancel_delay',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Period.appointment_mail_text'
        db.add_column('teleforma_period', 'appointment_mail_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'teleforma.appointment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jury': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'appointments'", 'to': "orm['teleforma.AppointmentJury']"}),
        ...
        'teleforma.appointmentday': {
            'Meta': {'object_name': 'AppointmentDay', 'db_table': "'teleforma_appointment_date'"},
            'appointment_period': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'days'", 'to': "orm['teleforma.AppointmentPeriod']"}),
        ...
        'teleforma.appointmentjury': {
            ...
            'day': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jurys'", 'to': "orm['teleforma.AppointmentDay']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.appointmentperiod': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'nb_appointments': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        'teleforma.appointmentslot': {
            ...
            'day': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'slots'", 'to': "orm['teleforma.AppointmentDay']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
