...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppointmentJury'
        db.create_table('teleforma_appointment_jury', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.related.ForeignKey')(related_name='jurys', to=orm['teleforma.AppointmentDay'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('address', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('teleforma', ['AppointmentJury'])

        # Adding model 'AppointmentPeriod'
        db.create_table('teleforma_appointment_period', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('period', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appointment_periods', to=orm['teleforma.Period'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('nb_appointments', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('teleforma', ['AppointmentPeriod'])
        ...
        db.create_table('teleforma_appointment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slot', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appointments', to=orm['teleforma.AppointmentSlot'])),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appointments', to=orm['auth.User'])),
            ('jury', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appointments', to=orm['teleforma.AppointmentJury'])),
            ('slot_nb', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('teleforma', ['Appointment'])

        # Adding model 'AppointmentSlot'
        db.create_table('teleforma_appointment_slot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.related.ForeignKey')(related_name='slots', to=orm['teleforma.AppointmentDay'])),
            ('start', self.gf('django.db.models.fields.TimeField')()),
            ('nb', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('teleforma', ['AppointmentSlot'])
    ...
    def backwards(self, orm):
        # Deleting model 'AppointmentJury'
        db.delete_table('teleforma_appointment_jury')

        # Deleting model 'AppointmentPeriod'
        db.delete_table('teleforma_appointment_period')

        # Deleting model 'AppointmentDay'
        db.delete_table('teleforma_appointment_date')

        # Deleting model 'Appointment'
        db.delete_table('teleforma_appointment')

        # Deleting model 'AppointmentSlot'
        db.delete_table('teleforma_appointment_slot')
    ...
    models = {
        ...
        'teleforma.appointmentjury': {
            'Meta': {'object_name': 'AppointmentJury', 'db_table': "'teleforma_appointment_jury'"},
        ...
        'teleforma.appointmentperiod': {
            'Meta': {'object_name': 'AppointmentPeriod', 'db_table': "'teleforma_appointment_period'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'nb_appointments': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'period': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'appointment_periods'", 'to': "orm['teleforma.Period']"})
        },
        'teleforma.appointmentslot': {
            'Meta': {'object_name': 'AppointmentSlot', 'db_table': "'teleforma_appointment_slot'"},
        ...
        'teleforma.period': {
            ...
            'appointment_slot_size': ('django.db.models.fields.TextField', [], {'default': '40'}),
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'enable_appointment': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
