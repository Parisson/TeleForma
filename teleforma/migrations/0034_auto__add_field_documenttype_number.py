...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentType.number'
        db.add_column('teleforma_document_type', 'number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DocumentType.number'
        db.delete_column('teleforma_document_type', 'number')
