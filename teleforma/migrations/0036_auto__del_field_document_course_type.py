...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field course_type on 'Document'
        db.create_table('teleforma_document_course_type', (
        ...
        db.create_unique('teleforma_document_course_type', ['document_id', 'coursetype_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field course_type on 'Document'
        db.delete_table('teleforma_document_course_type')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
