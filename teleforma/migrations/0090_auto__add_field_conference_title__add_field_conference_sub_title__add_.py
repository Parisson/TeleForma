...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field conferences on 'Auditor'
        db.create_table('teleforma_auditor_conferences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('auditor', models.ForeignKey(orm['teleforma.auditor'], null=False)),
            ('conference', models.ForeignKey(orm['teleforma.conference'], null=False))
        ))
        db.create_unique('teleforma_auditor_conferences', ['auditor_id', 'conference_id'])

        # Adding field 'Conference.title'
        db.add_column('teleforma_conference', 'title',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'Conference.sub_title'
        db.add_column('teleforma_conference', 'sub_title',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'Conference.price'
        db.add_column('teleforma_conference', 'price',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Removing M2M table for field conferences on 'Auditor'
        db.delete_table('teleforma_auditor_conferences')

        # Deleting field 'Conference.title'
        db.delete_column('teleforma_conference', 'title')

        # Deleting field 'Conference.sub_title'
        db.delete_column('teleforma_conference', 'sub_title')

        # Deleting field 'Conference.price'
        db.delete_column('teleforma_conference', 'price')
