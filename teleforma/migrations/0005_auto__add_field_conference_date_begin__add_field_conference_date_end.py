...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.date_begin'
        db.add_column('teleforma_conference', 'date_begin',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Conference.date_end'
        db.add_column('teleforma_conference', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Conference.date_begin'
        db.delete_column('teleforma_conference', 'date_begin')

        # Deleting field 'Conference.date_end'
        db.delete_column('teleforma_conference', 'date_end')
