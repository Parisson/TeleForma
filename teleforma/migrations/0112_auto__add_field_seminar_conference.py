...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.conference'
        db.add_column('teleforma_seminar', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='conference', null=True, on_delete=models.SET_NULL, to=orm['teleforma.Conference']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Seminar.conference'
        db.delete_column('teleforma_seminar', 'conference_id')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
