...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Department.default_period'
        db.add_column('teleforma_department', 'default_period',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='department', on_delete=models.SET_NULL, default=None, to=orm['teleforma.Period'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Department.default_period'
        db.delete_column('teleforma_department', 'default_period_id')
