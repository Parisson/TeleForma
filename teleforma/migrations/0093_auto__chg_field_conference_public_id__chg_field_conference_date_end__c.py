...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conference.sub_title'
        db.alter_column('teleforma_conference', 'sub_title', self.gf('django.db.models.fields.CharField')(max_length=1024))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Conference.sub_title'
        db.alter_column('teleforma_conference', 'sub_title', self.gf('telemeta.models.core.CharField')(max_length=1024))
