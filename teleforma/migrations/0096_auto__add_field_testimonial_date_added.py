...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Testimonial.date_added'
        db.add_column('teleforma_testimonial', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Testimonial.date_added'
        db.delete_column('teleforma_testimonial', 'date_added')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
