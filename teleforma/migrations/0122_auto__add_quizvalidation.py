...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuizValidation'
        db.create_table('teleforma_quiz_validation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quiz_validation', to=orm['auth.User'])),
            ('quiz', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quiz_validation', null=True, on_delete=models.SET_NULL, to=orm['quiz.Quiz'])),
            ('validated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_validated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('teleforma', ['QuizValidation'])


    def backwards(self, orm):
        # Deleting model 'QuizValidation'
        db.delete_table('teleforma_quiz_validation')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 1, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'period': ('telemeta.models.core.ForeignKey', [], {'related_name': "'seminar'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['teleforma.Period']", 'blank': 'True', 'null': 'True'}),
            'price': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
