...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_training_magistral', (
        ...
        db.create_unique('teleforma_training_magistral', ['training_id', 'coursetype_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teleforma_training_magistral')
