...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field audio on 'MediaPackage'
        db.create_table('teleforma_media_package_audio', (
        ...
        db.create_unique('teleforma_media_package_audio', ['mediapackage_id', 'media_id'])

        # Adding M2M table for field video on 'MediaPackage'
        db.create_table('teleforma_media_package_video', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mediapackage', models.ForeignKey(orm['teleforma.mediapackage'], null=False)),
            ('media', models.ForeignKey(orm['teleforma.media'], null=False))
        ))
        db.create_unique('teleforma_media_package_video', ['mediapackage_id', 'media_id'])

        # Adding field 'Media.rank'
        db.add_column('teleforma_media', 'rank',
                      self.gf('telemeta.models.core.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field audio on 'MediaPackage'
        db.delete_table('teleforma_media_package_audio')

        # Removing M2M table for field video on 'MediaPackage'
        db.delete_table('teleforma_media_package_video')

        # Deleting field 'Media.rank'
        db.delete_column('teleforma_media', 'rank')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
