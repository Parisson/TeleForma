...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('teleforma_evaluation', (
            ...
            ('form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='evaluation', to=orm['forms.Form'])),
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
