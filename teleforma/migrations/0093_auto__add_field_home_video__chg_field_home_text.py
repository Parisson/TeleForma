...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Home.video'
        db.add_column('teleforma_home', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teleforma.Media'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Home.video'
        db.delete_column('teleforma_home', 'video_id')
