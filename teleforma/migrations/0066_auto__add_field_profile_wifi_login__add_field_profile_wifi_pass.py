...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.wifi_login'
        db.add_column('teleforma_profiles', 'wifi_login',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Profile.wifi_pass'
        db.add_column('teleforma_profiles', 'wifi_pass',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.wifi_login'
        db.delete_column('teleforma_profiles', 'wifi_login')

        # Deleting field 'Profile.wifi_pass'
        db.delete_column('teleforma_profiles', 'wifi_pass')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 11, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
