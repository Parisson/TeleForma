...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_seminar_revisions', (
            ...
            ('seminar', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revision', to=orm['teleforma.Seminar'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revision', to=orm['auth.User'])),
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
