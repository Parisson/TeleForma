...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Media.weight'
        db.alter_column('teleforma_media', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Document.weight'
        db.alter_column('teleforma_document', 'weight', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Media.weight'
        db.alter_column('teleforma_media', 'weight', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Document.weight'
        db.alter_column('teleforma_document', 'weight', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'auth.group': {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'concerned': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
            'conference': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'conference'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['teleforma.Conference']"}),
