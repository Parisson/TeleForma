...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Training.description'
        db.add_column('teleforma_training', 'description',
    ...
    def backwards(self, orm):
        # Deleting field 'Training.description'
        db.delete_column('teleforma_training', 'description')
