...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Seminar.media'
        db.alter_column('teleforma_seminar', 'media_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.Media']))

        # Changing field 'Seminar.media_preview'
        db.alter_column('teleforma_seminar', 'media_preview_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.Media']))
    models = {
        'auth.group': {
        ...
        'teleforma.mediapro': {
            'Meta': {'object_name': 'MediaPro', 'db_table': "'teleforma_pro_media'"},
            'audio_items': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'media_pro_audio'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['telemeta.MediaItem']"}),
            'code': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'credits': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'date_added': ('telemeta.models.core.DateTimeField', [], {'default': 'None', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_modified': ('telemeta.models.core.DateTimeField', [], {'default': 'None', 'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'is_published': ('telemeta.models.core.BooleanField', [], {'default': 'False'}),
            'mime_type': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'readers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'media_pro'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.User']"}),
            'title': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'video_items': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'media_pro_video'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['telemeta.MediaItem']"}),
            'weight': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'})
        },
        ...
        'teleforma.seminar': {
            ...
            'media': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'seminar_media'", 'null': 'True', 'to': "orm['teleforma.MediaPro']"}),
            'media_preview': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'seminar_media_preview'", 'null': 'True', 'to': "orm['teleforma.MediaPro']"}),
