...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auditor.company'
        db.add_column('teleforma_auditor', 'company',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.fax'
        db.add_column('teleforma_auditor', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Auditor.company'
        db.delete_column('teleforma_auditor', 'company')

        # Deleting field 'Auditor.fax'
        db.delete_column('teleforma_auditor', 'fax')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
