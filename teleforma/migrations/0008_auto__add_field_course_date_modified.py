...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.date_modified'
        db.add_column('teleforma_course', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 4, 13, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Course.date_modified'
        db.delete_column('teleforma_course', 'date_modified')
