...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSimple.type'
        db.add_column('teleforma_document_simple', 'type',
                      self.gf('telemeta.models.core.ForeignKey')(default=None, related_name='document_simple', null=True, blank=True, to=orm['teleforma.DocumentType']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DocumentSimple.type'
        db.delete_column('teleforma_document_simple', 'type_id')
