...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Testimonial.template'
        db.alter_column('teleforma_testimonial', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.TestimonialTemplate']))
    def backwards(self, orm):

        # Changing field 'Testimonial.template'
        db.alter_column('teleforma_testimonial', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.TestimonialTemplate']))
    models = {
        'auth.group': {
