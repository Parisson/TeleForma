...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.location'
        db.add_column('teleforma_conference', 'location',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, to=orm['telemeta.Location'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Conference.location'
        db.delete_column('teleforma_conference', 'location_id')
