...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentType.for_corrector'
        db.add_column('teleforma_document_type', 'for_corrector',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentType.for_corrector'
        db.delete_column('teleforma_document_type', 'for_corrector')
