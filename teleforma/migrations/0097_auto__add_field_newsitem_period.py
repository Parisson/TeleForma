...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.period'
        db.add_column('teleforma_newsitem', 'period',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='newsitems', null=True, to=orm['teleforma.Period']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.period'
        db.delete_column('teleforma_newsitem', 'period_id')
