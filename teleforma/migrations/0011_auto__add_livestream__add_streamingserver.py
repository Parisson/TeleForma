...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LiveStream'
        db.create_table('teleforma_live_stream', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='livestream', to=orm['teleforma.Conference'])),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(related_name='livestream', to=orm['teleforma.StreamingServer'])),
            ('stream_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('teleforma', ['LiveStream'])

        # Adding model 'StreamingServer'
        db.create_table('teleforma_streaming_server', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('port', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('source_password', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('admin_password', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ))
        db.send_create_signal('teleforma', ['StreamingServer'])

    def backwards(self, orm):
        # Deleting model 'LiveStream'
        db.delete_table('teleforma_live_stream')

        # Deleting model 'StreamingServer'
        db.delete_table('teleforma_streaming_server')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
