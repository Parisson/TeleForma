...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.concerned'
        db.add_column('teleforma_conference', 'concerned',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'Conference.level'
        db.add_column('teleforma_conference', 'level',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Conference.course_type'
        db.alter_column('teleforma_conference', 'course_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.CourseType']))
    def backwards(self, orm):
        # Deleting field 'Conference.concerned'
        db.delete_column('teleforma_conference', 'concerned')

        # Deleting field 'Conference.level'
        db.delete_column('teleforma_conference', 'level')


        # Changing field 'Conference.course_type'
        db.alter_column('teleforma_conference', 'course_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.CourseType']))
    models = {
        'auth.group': {
