...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field magistral_courses on 'Training'
        db.create_table('teleforma_training_magistral_courses', (
        ...
        db.create_unique('teleforma_training_magistral_courses', ['training_id', 'course_id'])

    def backwards(self, orm):
        # Removing M2M table for field magistral_courses on 'Training'
        db.delete_table('teleforma_training_magistral_courses')
