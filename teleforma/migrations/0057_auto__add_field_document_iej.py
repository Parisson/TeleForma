...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.iej'
        db.add_column('teleforma_document', 'iej',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='document', on_delete=models.SET_NULL, default=None, to=orm['teleforma.IEJ'], blank=True, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.iej'
        db.delete_column('teleforma_document', 'iej_id')
