...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.course_type'
        db.add_column('teleforma_document', 'course_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='document', to=orm['teleforma.CourseType']),
                      keep_default=False)

        # Adding field 'LiveStream.course'
        db.add_column('teleforma_live_stream', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='livestream', to=orm['teleforma.Course']),
                      keep_default=False)

        # Adding field 'LiveStream.course_type'
        db.add_column('teleforma_live_stream', 'course_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='livestream', to=orm['teleforma.CourseType']),
                      keep_default=False)


        # Changing field 'LiveStream.conference'
        db.alter_column('teleforma_live_stream', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.Conference']))
        # Adding field 'Media.course_type'
        db.add_column('teleforma_media', 'course_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='media', to=orm['teleforma.CourseType']),
                      keep_default=False)

        # Adding field 'Conference.course_type'
        db.add_column('teleforma_conference', 'course_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='conference', to=orm['teleforma.CourseType']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.course_type'
        db.delete_column('teleforma_document', 'course_type_id')

        # Deleting field 'LiveStream.course'
        db.delete_column('teleforma_live_stream', 'course_id')

        # Deleting field 'LiveStream.course_type'
        db.delete_column('teleforma_live_stream', 'course_type_id')


        # Changing field 'LiveStream.conference'
        db.alter_column('teleforma_live_stream', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.Conference']))
        # Deleting field 'Media.course_type'
        db.delete_column('teleforma_media', 'course_type_id')

        # Deleting field 'Conference.course_type'
        db.delete_column('teleforma_conference', 'course_type_id')
