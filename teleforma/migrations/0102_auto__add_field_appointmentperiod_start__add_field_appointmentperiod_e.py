...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppointmentPeriod.start'
        db.add_column('teleforma_appointment_period', 'start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2018, 9, 18, 0, 0)),
                      keep_default=False)

        # Adding field 'AppointmentPeriod.end'
        db.add_column('teleforma_appointment_period', 'end',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2018, 9, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppointmentPeriod.start'
        db.delete_column('teleforma_appointment_period', 'start')

        # Deleting field 'AppointmentPeriod.end'
        db.delete_column('teleforma_appointment_period', 'end')
