...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conference.room'
        db.add_column('teleforma_conference', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='conference', null=True, to=orm['teleforma.Room']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Conference.room'
        db.delete_column('teleforma_conference', 'room_id')
    ...
    models = {
        ...
        'teleforma.conference': {
            ...
            'room': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'conference'", 'null': 'True', 'to': "orm['teleforma.Room']"}),
