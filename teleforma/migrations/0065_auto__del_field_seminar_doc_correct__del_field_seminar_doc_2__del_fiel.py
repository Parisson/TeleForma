...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Seminar.doc_correct'
        db.delete_column('teleforma_seminar', 'doc_correct_id')

        # Deleting field 'Seminar.doc_2'
        db.delete_column('teleforma_seminar', 'doc_2_id')

        # Deleting field 'Seminar.doc_1'
        db.delete_column('teleforma_seminar', 'doc_1_id')
        ...
        db.create_unique('teleforma_seminar_doc_1', ['seminar_id', 'documentsimple_id'])
        ...
        db.create_unique('teleforma_seminar_doc_2', ['seminar_id', 'documentsimple_id'])
        ...
        db.create_unique('teleforma_seminar_doc_correct', ['seminar_id', 'documentsimple_id'])


        # Changing field 'Question.question'
        db.alter_column('teleforma_question', 'question', self.gf('tinymce.models.HTMLField')())
        # Deleting field 'DocumentSimple.period'
        db.delete_column('teleforma_document_simple', 'period_id')

    def backwards(self, orm):
        # Adding field 'Seminar.doc_correct'
        db.add_column('teleforma_seminar', 'doc_correct',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_doccorrect', null=True, to=orm['teleforma.DocumentSimple'], blank=True),
                      keep_default=False)

        # Adding field 'Seminar.doc_2'
        db.add_column('teleforma_seminar', 'doc_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_doc2', null=True, to=orm['teleforma.DocumentSimple'], blank=True),
                      keep_default=False)

        # Adding field 'Seminar.doc_1'
        db.add_column('teleforma_seminar', 'doc_1',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_doc1', null=True, to=orm['teleforma.DocumentSimple'], blank=True),
                      keep_default=False)
        ...
        # Changing field 'Question.question'
        db.alter_column('teleforma_question', 'question', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
