...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Appointment', fields ['slot', 'jury', 'slot_nb']
        db.create_unique('teleforma_appointment', ['slot_id', 'jury_id', 'slot_nb'])


    def backwards(self, orm):
        # Removing unique constraint on 'Appointment', fields ['slot', 'jury', 'slot_nb']
        db.delete_unique('teleforma_appointment', ['slot_id', 'jury_id', 'slot_nb'])
