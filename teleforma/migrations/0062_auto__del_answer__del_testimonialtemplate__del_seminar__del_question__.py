...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conference.status'
        db.add_column('teleforma_conference', 'status',
    ...
    def backwards(self, orm):
        ...
        db.create_table('teleforma_testimonial_template', (
            ...
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'testimonial_template', to=orm['teleforma.DocumentSimple'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        db.create_table('teleforma_seminar', (
            ('status', self.gf('django.db.models.fields.IntegerField')(default=2, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('media', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar', null=True, to=orm['teleforma.Media'], blank=True)),
            ('concerned', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('doc_correct', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_doccorrect', null=True, to=orm['teleforma.DocumentSimple'], blank=True)),
            ...
            ('doc_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_doc2', null=True, to=orm['teleforma.DocumentSimple'], blank=True)),
            ('rank', self.gf('django.db.models.fields.IntegerField')()),
            ('keywords', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
            ('doc_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_doc1', null=True, to=orm['teleforma.DocumentSimple'], blank=True)),
        ...
        db.create_table('teleforma_testimonial', (
            ...
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'testimonial', to=orm['teleforma.TestimonialTemplate'])),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'testimonial', null=True, to=orm['teleforma.DocumentSimple'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seminar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teleforma.Seminar'])),
        ))
        db.send_create_signal('teleforma', ['Testimonial'])

        # Deleting field 'Conference.status'
        db.delete_column('teleforma_conference', 'status')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.document': {
            ...
            'annal_year': ('telemeta.models.core.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'code': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iej': ('telemeta.models.core.ForeignKey', [], {'related_name': "'document'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['teleforma.IEJ']", 'blank': 'True', 'null': 'True'}),
