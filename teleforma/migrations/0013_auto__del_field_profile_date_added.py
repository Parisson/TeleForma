...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.date_added'
        db.delete_column('teleforma_profiles', 'date_added')

    def backwards(self, orm):
        # Adding field 'Profile.date_added'
        db.add_column('teleforma_profiles', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 27, 0, 0), blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
