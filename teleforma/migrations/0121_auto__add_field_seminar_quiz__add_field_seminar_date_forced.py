...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.quiz'
        db.add_column('teleforma_seminar', 'quiz',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='seminar', null=True, on_delete=models.SET_NULL, to=orm['quiz.Quiz']),
                      keep_default=False)

        # Adding field 'Seminar.date_forced'
        db.add_column('teleforma_seminar', 'date_forced',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seminar.quiz'
        db.delete_column('teleforma_seminar', 'quiz_id')

        # Deleting field 'Seminar.date_forced'
        db.delete_column('teleforma_seminar', 'date_forced')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 12, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'date_forced': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
