...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_course_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('teleforma', ['CourseGroup'])

        # Adding M2M table for field courses on 'CourseGroup'
        m2m_table_name = db.shorten_name('teleforma_course_group_courses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coursegroup', models.ForeignKey(orm['teleforma.coursegroup'], null=False)),
            ('course', models.ForeignKey(orm['teleforma.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['coursegroup_id', 'course_id'])

        # Adding field 'Student.promo_code'
        db.add_column('teleforma_student', 'promo_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Student.level'
        db.add_column('teleforma_student', 'level',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Profile.birthday'
        db.add_column('teleforma_profiles', 'birthday',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teleforma_course_group')

        # Removing M2M table for field courses on 'CourseGroup'
        db.delete_table(db.shorten_name('teleforma_course_group_courses'))

        # Deleting field 'Student.promo_code'
        db.delete_column('teleforma_student', 'promo_code')

        # Deleting field 'Student.level'
        db.delete_column('teleforma_student', 'level')

        # Deleting field 'Profile.birthday'
        db.delete_column('teleforma_profiles', 'birthday')
