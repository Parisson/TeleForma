...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seminar.description'
        db.alter_column('teleforma_seminar', 'description', self.gf('django.db.models.fields.TextField')())
    def backwards(self, orm):

        # Changing field 'Seminar.description'
        db.alter_column('teleforma_seminar', 'description', self.gf('django.db.models.fields.CharField')(max_length=1024))
    models = {
        'auth.group': {
