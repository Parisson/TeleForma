...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.no_type'
        db.delete_column('teleforma_course', 'no_type')
    ...
    def backwards(self, orm):
        # Adding field 'Course.no_type'
        db.add_column('teleforma_course', 'no_type',
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
