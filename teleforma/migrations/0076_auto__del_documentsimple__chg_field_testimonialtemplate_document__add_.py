...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field readers on 'DocumentSimple'
        db.delete_table('teleforma_document_simple_readers')


        # Changing field 'TestimonialTemplate.document'
        db.alter_column('teleforma_testimonial_template', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teleforma.Document']))
        # Adding field 'Document.rank'
        db.add_column('teleforma_document', 'rank',
    ...
    def backwards(self, orm):
        ...
        db.create_table('teleforma_document_simple', (
            ...
            ('file', self.gf('telemeta.models.core.FileField')(default='', max_length=1024, db_column='filename', blank=True)),
            ...
            ('title', self.gf('telemeta.models.core.CharField')(default='', max_length=1024, blank=True)),
            ('type', self.gf('telemeta.models.core.ForeignKey')(default=None, related_name='document_simple', null=True, to=orm['teleforma.DocumentType'], blank=True)),
        ...
        # Adding M2M table for field readers on 'DocumentSimple'
        db.create_table('teleforma_document_simple_readers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('documentsimple', models.ForeignKey(orm['teleforma.documentsimple'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('teleforma_document_simple_readers', ['documentsimple_id', 'user_id'])


        # Changing field 'TestimonialTemplate.document'
        db.alter_column('teleforma_testimonial_template', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teleforma.DocumentSimple']))
        # Deleting field 'Document.rank'
        db.delete_column('teleforma_document', 'rank')


        # Changing field 'Document.course'
        db.alter_column('teleforma_document', 'course_id', self.gf('telemeta.models.core.ForeignKey')(default=1, to=orm['teleforma.Course']))
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'doc_1': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doc1'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Document']"}),
            'doc_2': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doc2'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Document']"}),
            'doc_correct': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doccorrect'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Document']"}),
