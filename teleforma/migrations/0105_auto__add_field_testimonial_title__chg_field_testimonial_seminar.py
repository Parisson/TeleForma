...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Testimonial.title'
        db.add_column('teleforma_testimonial', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Testimonial.seminar'
        db.alter_column('teleforma_testimonial', 'seminar_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['teleforma.Seminar']))
    def backwards(self, orm):
        # Deleting field 'Testimonial.title'
        db.delete_column('teleforma_testimonial', 'title')


        # Changing field 'Testimonial.seminar'
        db.alter_column('teleforma_testimonial', 'seminar_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.Seminar']))
    models = {
        'auth.group': {
