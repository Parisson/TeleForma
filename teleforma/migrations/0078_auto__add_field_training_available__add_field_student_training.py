...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Training.available'
        db.add_column('teleforma_training', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Student.training'
        db.add_column('teleforma_student', 'training',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='student_training', null=True, to=orm['teleforma.Training']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Training.available'
        db.delete_column('teleforma_training', 'available')
