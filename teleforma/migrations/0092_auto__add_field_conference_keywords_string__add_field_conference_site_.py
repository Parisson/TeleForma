...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.keywords_string'
        db.add_column('teleforma_conference', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Conference.site'
        db.add_column('teleforma_conference', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Conference.title'
        db.add_column('teleforma_conference', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=500),
                      keep_default=False)

        # Adding field 'Conference.slug'
        db.add_column('teleforma_conference', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Conference._meta_title'
        db.add_column('teleforma_conference', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Conference.description'
        db.add_column('teleforma_conference', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Conference.gen_description'
        db.add_column('teleforma_conference', 'gen_description',
        ...
        # Adding field 'Conference.publish_date'
        db.add_column('teleforma_conference', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Conference.expiry_date'
        db.add_column('teleforma_conference', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Conference.short_url'
        db.add_column('teleforma_conference', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Conference.keywords_string'
        db.delete_column('teleforma_conference', 'keywords_string')

        # Deleting field 'Conference.site'
        db.delete_column('teleforma_conference', 'site_id')

        # Deleting field 'Conference.title'
        db.delete_column('teleforma_conference', 'title')

        # Deleting field 'Conference.slug'
        db.delete_column('teleforma_conference', 'slug')

        # Deleting field 'Conference._meta_title'
        db.delete_column('teleforma_conference', '_meta_title')

        # Deleting field 'Conference.description'
        db.delete_column('teleforma_conference', 'description')

        # Deleting field 'Conference.gen_description'
        db.delete_column('teleforma_conference', 'gen_description')

        # Deleting field 'Conference.status'
        db.delete_column('teleforma_conference', 'status')

        # Deleting field 'Conference.publish_date'
        db.delete_column('teleforma_conference', 'publish_date')

        # Deleting field 'Conference.expiry_date'
        db.delete_column('teleforma_conference', 'expiry_date')

        # Deleting field 'Conference.short_url'
        db.delete_column('teleforma_conference', 'short_url')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.conference': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '2'}),
            'sub_title': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        },
        'teleforma.course': {
