...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LiveStream.streaming'
        db.add_column('teleforma_live_stream', 'streaming',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'LiveStream.course_type'
        db.alter_column('teleforma_live_stream', 'course_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['teleforma.CourseType']))
        # Deleting field 'Conference.streaming'
        db.delete_column('teleforma_conference', 'streaming')

    def backwards(self, orm):
        # Deleting field 'LiveStream.streaming'
        db.delete_column('teleforma_live_stream', 'streaming')


        # Changing field 'LiveStream.course_type'
        db.alter_column('teleforma_live_stream', 'course_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.CourseType']))
        # Adding field 'Conference.streaming'
        db.add_column('teleforma_conference', 'streaming',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 19, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.livestream': {
            ...
            'course_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'livestream'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['teleforma.CourseType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
