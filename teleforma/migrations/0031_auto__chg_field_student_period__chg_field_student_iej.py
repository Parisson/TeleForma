...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Student.period'
        db.alter_column('teleforma_student', 'period_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.Period']))

        # Changing field 'Student.iej'
        db.alter_column('teleforma_student', 'iej_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.IEJ']))
    models = {
        'auth.group': {
