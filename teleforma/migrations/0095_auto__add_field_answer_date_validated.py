...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.date_validated'
        db.add_column('teleforma_answer', 'date_validated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Answer.date_validated'
        db.delete_column('teleforma_answer', 'date_validated')
