...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Department.address'
        db.add_column('teleforma_department', 'address',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Department.signature'
        db.add_column('teleforma_department', 'signature',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Department.address'
        db.delete_column('teleforma_department', 'address')

        # Deleting field 'Department.signature'
        db.delete_column('teleforma_department', 'signature')
