...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teleforma_professor', 'department',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='professor', on_delete=models.SET_NULL, default=None, to=orm['teleforma.Department'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Professor.department'
        db.delete_column('teleforma_professor', 'department_id')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
