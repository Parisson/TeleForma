...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Professor', fields ['user']
        db.create_unique('teleforma_professor', ['user_id'])

        # Adding unique constraint on 'Student', fields ['user']
        db.create_unique('teleforma_student', ['user_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Student', fields ['user']
        db.delete_unique('teleforma_student', ['user_id'])

        # Removing unique constraint on 'Professor', fields ['user']
        db.delete_unique('teleforma_professor', ['user_id'])
