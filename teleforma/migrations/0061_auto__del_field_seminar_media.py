...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Seminar.media'
        db.delete_column('teleforma_seminar', 'media_id')
    ...
    def backwards(self, orm):
        # Adding field 'Seminar.media'
        db.add_column('teleforma_seminar', 'media',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='seminar_media', null=True, to=orm['teleforma.MediaPackage'], blank=True),
                      keep_default=False)
