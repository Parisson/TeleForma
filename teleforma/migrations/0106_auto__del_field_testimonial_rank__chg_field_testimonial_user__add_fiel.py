...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Testimonial.user'
        db.alter_column('teleforma_testimonial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
        # Adding field 'Conference.duration'
        db.add_column('teleforma_conference', 'duration',
                      self.gf('telemeta.models.core.DurationField')(default='0', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Testimonial.user'
        db.alter_column('teleforma_testimonial', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 1, 25, 0, 0), to=orm['auth.User']))
        # Deleting field 'Conference.duration'
        db.delete_column('teleforma_conference', 'duration')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'media_preview': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'seminar_preview'", 'null': 'True', 'to': "orm['teleforma.Media']"}),
