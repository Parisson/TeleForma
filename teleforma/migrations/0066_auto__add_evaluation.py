...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_evaluation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seminar', self.gf('django.db.models.fields.related.ForeignKey')(related_name='evaluation', to=orm['teleforma.Seminar'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='evaluation', to=orm['auth.User'])),
        ))
        db.send_create_signal('teleforma', ['Evaluation'])

    def backwards(self, orm):
        # Deleting model 'Evaluation'
        db.delete_table('teleforma_evaluation')
