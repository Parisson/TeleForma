...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Audio.mime_type'
        db.alter_column('teleforma_audio', 'mime_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Document.mime_type'
        db.alter_column('teleforma_document', 'mime_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Video.mime_type'
        db.alter_column('teleforma_video', 'mime_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    def backwards(self, orm):

        # Changing field 'Audio.mime_type'
        db.alter_column('teleforma_audio', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Document.mime_type'
        db.alter_column('teleforma_document', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Video.mime_type'
        db.alter_column('teleforma_video', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    models = {
        'auth.group': {
