...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Auditor.city'
        db.alter_column('teleforma_auditor', 'city', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Auditor.language'
        db.alter_column('teleforma_auditor', 'language', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Auditor.expiration_date'
        db.alter_column('teleforma_auditor', 'expiration_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Auditor.init_password'
        db.alter_column('teleforma_auditor', 'init_password', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Auditor.telephone'
        db.alter_column('teleforma_auditor', 'telephone', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Auditor.platform_only'
        db.alter_column('teleforma_auditor', 'platform_only', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Auditor.postal_code'
        db.alter_column('teleforma_auditor', 'postal_code', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Auditor.country'
        db.alter_column('teleforma_auditor', 'country', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Auditor.address'
        db.alter_column('teleforma_auditor', 'address', self.gf('django.db.models.fields.TextField')())
    def backwards(self, orm):

        # Changing field 'Auditor.city'
        db.alter_column('teleforma_auditor', 'city', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'Auditor.language'
        db.alter_column('teleforma_auditor', 'language', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'Auditor.expiration_date'
        db.alter_column('teleforma_auditor', 'expiration_date', self.gf('telemeta.models.core.DateField')(null=True))

        # Changing field 'Auditor.init_password'
        db.alter_column('teleforma_auditor', 'init_password', self.gf('telemeta.models.core.BooleanField')())

        # Changing field 'Auditor.telephone'
        db.alter_column('teleforma_auditor', 'telephone', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'Auditor.platform_only'
        db.alter_column('teleforma_auditor', 'platform_only', self.gf('telemeta.models.core.BooleanField')())

        # Changing field 'Auditor.postal_code'
        db.alter_column('teleforma_auditor', 'postal_code', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'Auditor.country'
        db.alter_column('teleforma_auditor', 'country', self.gf('telemeta.models.core.CharField')(max_length=255))

        # Changing field 'Auditor.address'
        db.alter_column('teleforma_auditor', 'address', self.gf('telemeta.models.core.TextField')())
    models = {
        'auth.group': {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'doc_1': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doc1'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.DocumentSimple']"}),
            'doc_2': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doc2'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.DocumentSimple']"}),
            'doc_correct': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_doccorrect'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.DocumentSimple']"}),
