...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OptionalFee'
        db.create_table('teleforma_optional_fees', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='optional_fees', to=orm['teleforma.Student'])),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('teleforma', ['OptionalFee'])

        # Adding model 'Discount'
        db.create_table('teleforma_discounts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discounts', to=orm['teleforma.Student'])),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('teleforma', ['Discount'])

        # Adding field 'Student.application_fees'
        db.add_column('teleforma_student', 'application_fees',
                      self.gf('telemeta.models.core.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Student.subscription_fees'
        db.add_column('teleforma_student', 'subscription_fees',
    ...
    def backwards(self, orm):
        # Deleting model 'OptionalFee'
        db.delete_table('teleforma_optional_fees')

        # Deleting model 'Discount'
        db.delete_table('teleforma_discounts')

        # Deleting field 'Student.application_fees'
        db.delete_column('teleforma_student', 'application_fees')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.professor': {
            ...
            'department': ('telemeta.models.core.ForeignKey', [], {'related_name': "'professor'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': "orm['teleforma.Department']", 'blank': 'True', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.profile': {
            ...
            'wifi_login': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'wifi_pass': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'})
        },
        'teleforma.room': {
