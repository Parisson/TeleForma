...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WebClassGroup'
        db.delete_table('teleforma_webclassgroup')

        # Removing M2M table for field iejs on 'WebClassGroup'
        db.delete_table(db.shorten_name('teleforma_webclassgroup_iejs'))

        # Adding model 'ClassGroup'
        db.create_table('teleforma_classgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('teleforma', ['ClassGroup'])

        # Adding M2M table for field iejs on 'ClassGroup'
        m2m_table_name = db.shorten_name('teleforma_classgroup_iejs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('classgroup', models.ForeignKey(orm['teleforma.classgroup'], null=False)),
            ('iej', models.ForeignKey(orm['teleforma.iej'], null=False))
        ))
        db.create_unique(m2m_table_name, ['classgroup_id', 'iej_id'])

        # Deleting field 'Conference.web_class_group'
        db.delete_column('teleforma_conference', 'web_class_group_id')

        # Adding field 'Conference.class_group'
        db.add_column('teleforma_conference', 'class_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='conferences', null=True, on_delete=models.SET_NULL, to=orm['teleforma.ClassGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'WebClassGroup'
        db.create_table('teleforma_webclassgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('teleforma', ['WebClassGroup'])

        # Adding M2M table for field iejs on 'WebClassGroup'
        m2m_table_name = db.shorten_name('teleforma_webclassgroup_iejs')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('webclassgroup', models.ForeignKey(orm['teleforma.webclassgroup'], null=False)),
            ('iej', models.ForeignKey(orm['teleforma.iej'], null=False))
        ))
        db.create_unique(m2m_table_name, ['webclassgroup_id', 'iej_id'])

        # Deleting model 'ClassGroup'
        db.delete_table('teleforma_classgroup')

        # Removing M2M table for field iejs on 'ClassGroup'
        db.delete_table(db.shorten_name('teleforma_classgroup_iejs'))

        # Adding field 'Conference.web_class_group'
        db.add_column('teleforma_conference', 'web_class_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='conferences', null=True, to=orm['teleforma.WebClassGroup'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Deleting field 'Conference.class_group'
        db.delete_column('teleforma_conference', 'class_group_id')
    ...
    models = {
        ...
        'teleforma.course': {
            ...
            'exam_scripts': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
