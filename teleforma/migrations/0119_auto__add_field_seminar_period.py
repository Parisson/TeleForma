...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.period'
        db.add_column('teleforma_seminar', 'period',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='seminar', on_delete=models.SET_NULL, default=None, to=orm['teleforma.Period'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seminar.period'
        db.delete_column('teleforma_seminar', 'period_id')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminarrevision': {
            'Meta': {'ordering': "['-date_modified']", 'object_name': 'SeminarRevision', 'db_table': "'teleforma_seminar_revisions'"},
