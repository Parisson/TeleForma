...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Period.parent'
        db.add_column('teleforma_period', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['teleforma.Period']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Period.parent'
        db.delete_column('teleforma_period', 'parent_id')
