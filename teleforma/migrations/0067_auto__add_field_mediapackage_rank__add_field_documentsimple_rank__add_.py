...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaPackage.rank'
        db.add_column('teleforma_media_package', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DocumentSimple.rank'
        db.add_column('teleforma_document_simple', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Testimonial.rank'
        db.add_column('teleforma_testimonial', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MediaPackage.rank'
        db.delete_column('teleforma_media_package', 'rank')

        # Deleting field 'DocumentSimple.rank'
        db.delete_column('teleforma_document_simple', 'rank')

        # Deleting field 'Testimonial.rank'
        db.delete_column('teleforma_testimonial', 'rank')
