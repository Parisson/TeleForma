...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teleforma_seminar', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 13, 0, 0)))

        # Changing field 'Seminar.date_modified'
        db.alter_column('teleforma_seminar', 'date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 13, 0, 0)))
