...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teleforma_course', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.CourseType']))
    def backwards(self, orm):

        # Changing field 'Course.type'
        db.alter_column('teleforma_course', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.CourseType']))
    models = {
        'auth.group': {
