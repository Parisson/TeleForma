...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auditor.address'
        db.add_column('teleforma_auditor', 'address',
                      self.gf('telemeta.models.core.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Auditor.postal_code'
        db.add_column('teleforma_auditor', 'postal_code',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.city'
        db.add_column('teleforma_auditor', 'city',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.country'
        db.add_column('teleforma_auditor', 'country',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.language'
        db.add_column('teleforma_auditor', 'language',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.telephone'
        db.add_column('teleforma_auditor', 'telephone',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.expiration_date'
        db.add_column('teleforma_auditor', 'expiration_date',
                      self.gf('telemeta.models.core.DateField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.init_password'
        db.add_column('teleforma_auditor', 'init_password',
    ...
    def backwards(self, orm):
        # Deleting field 'Auditor.address'
        db.delete_column('teleforma_auditor', 'address')

        # Deleting field 'Auditor.postal_code'
        db.delete_column('teleforma_auditor', 'postal_code')

        # Deleting field 'Auditor.city'
        db.delete_column('teleforma_auditor', 'city')

        # Deleting field 'Auditor.country'
        db.delete_column('teleforma_auditor', 'country')

        # Deleting field 'Auditor.language'
        db.delete_column('teleforma_auditor', 'language')

        # Deleting field 'Auditor.telephone'
        db.delete_column('teleforma_auditor', 'telephone')

        # Deleting field 'Auditor.expiration_date'
        db.delete_column('teleforma_auditor', 'expiration_date')

        # Deleting field 'Auditor.init_password'
        db.delete_column('teleforma_auditor', 'init_password')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 20, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
