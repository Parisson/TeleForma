...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaPackage.title'
        db.alter_column('teleforma_media_package', 'title', self.gf('telemeta.models.core.CharField')(max_length=1024))

        # Changing field 'Media.title'
        db.alter_column('teleforma_media', 'title', self.gf('telemeta.models.core.CharField')(max_length=1024))

        # Changing field 'Document.title'
        db.alter_column('teleforma_document', 'title', self.gf('telemeta.models.core.CharField')(max_length=1024))
        ...
        db.alter_column('teleforma_document_simple', 'title', self.gf('telemeta.models.core.CharField')(max_length=1024))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MediaPackage.title'
        db.alter_column('teleforma_media_package', 'title', self.gf('telemeta.models.core.CharField')(max_length=255))
        ...
        # Changing field 'DocumentSimple.file'
        db.alter_column('teleforma_document_simple', 'filename', self.gf('telemeta.models.core.FileField')(max_length=100, db_column='filename'))
    models = {
        'auth.group': {
        ...
        'teleforma.documentsimple': {
            ...
            'title': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'type': ('telemeta.models.core.ForeignKey', [], {'default': 'None', 'related_name': "'document_simple'", 'null': 'True', 'blank': 'True', 'to': "orm['teleforma.DocumentType']"}),
            'weight': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'})
        },
