...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Testimonial.document'
        db.delete_column('teleforma_testimonial', 'document_id')

        # Adding field 'Testimonial.file'
        db.add_column('teleforma_testimonial', 'file',
                      self.gf('django.db.models.fields.files.FileField')(default=1, max_length=1024, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Testimonial.document'
        db.add_column('teleforma_testimonial', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='testimonial', null=True, to=orm['teleforma.Document'], blank=True),
                      keep_default=False)

        # Deleting field 'Testimonial.file'
        db.delete_column('teleforma_testimonial', 'file')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 29, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
