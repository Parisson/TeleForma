...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Period.date_password_init'
        db.add_column('teleforma_period', 'date_password_init',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Period.message_platform'
        db.add_column('teleforma_period', 'message_platform',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Period.message_local'
        db.add_column('teleforma_period', 'message_local',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Period.date_password_init'
        db.delete_column('teleforma_period', 'date_password_init')

        # Deleting field 'Period.message_platform'
        db.delete_column('teleforma_period', 'message_platform')

        # Deleting field 'Period.message_local'
        db.delete_column('teleforma_period', 'message_local')
    ...
    models = {
        ...
        'teleforma.student': {
            ...
            'written_speciality': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'written_speciality_students'", 'null': 'True', 'to': "orm['teleforma.Course']"})
        },
