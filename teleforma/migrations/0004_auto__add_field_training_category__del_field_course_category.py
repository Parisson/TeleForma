...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teleforma_training', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='course', to=orm['teleforma.Category']),
                      keep_default=False)

        # Deleting field 'Course.category'
        db.delete_column('teleforma_course', 'category_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('teleforma_course', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='course', to=orm['teleforma.Category']),
                      keep_default=False)
