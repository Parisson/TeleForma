...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.conference'
        db.add_column('teleforma_document', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='document', null=True, to=orm['teleforma.Conference']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.conference'
        db.delete_column('teleforma_document', 'conference_id')
