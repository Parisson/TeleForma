...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field media_preview on 'Seminar'
        db.delete_table('teleforma_seminar_media_preview')

        # Removing M2M table for field media on 'Seminar'
        db.delete_table('teleforma_seminar_media')

        # Adding M2M table for field medias on 'Seminar'
        db.create_table('teleforma_seminar_medias', (
        ...
        db.create_unique('teleforma_seminar_medias', ['seminar_id', 'media_id'])

        # Adding M2M table for field media_previews on 'Seminar'
        db.create_table('teleforma_seminar_media_previews', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('media', models.ForeignKey(orm['teleforma.media'], null=False))
        ))
        db.create_unique('teleforma_seminar_media_previews', ['seminar_id', 'media_id'])

    def backwards(self, orm):
        # Adding M2M table for field media_preview on 'Seminar'
        db.create_table('teleforma_seminar_media_preview', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('mediapackage', models.ForeignKey(orm['teleforma.mediapackage'], null=False))
        ))
        db.create_unique('teleforma_seminar_media_preview', ['seminar_id', 'mediapackage_id'])

        # Adding M2M table for field media on 'Seminar'
        db.create_table('teleforma_seminar_media', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('seminar', models.ForeignKey(orm['teleforma.seminar'], null=False)),
            ('mediapackage', models.ForeignKey(orm['teleforma.mediapackage'], null=False))
        ))
        db.create_unique('teleforma_seminar_media', ['seminar_id', 'mediapackage_id'])

        # Removing M2M table for field medias on 'Seminar'
        db.delete_table('teleforma_seminar_medias')

        # Removing M2M table for field media_previews on 'Seminar'
        db.delete_table('teleforma_seminar_media_previews')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'media_previews': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_media_preview'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Media']"}),
