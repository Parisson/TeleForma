...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field docs_description on 'Conference'
        db.create_table('teleforma_conference_docs_description', (
        ...
        db.create_unique('teleforma_conference_docs_description', ['conference_id', 'document_id'])

    def backwards(self, orm):
        # Removing M2M table for field docs_description on 'Conference'
        db.delete_table('teleforma_conference_docs_description')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
