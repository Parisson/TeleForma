...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Period.date_exam_end'
        db.add_column('teleforma_period', 'date_exam_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Period.date_exam_end'
        db.delete_column('teleforma_period', 'date_exam_end')
