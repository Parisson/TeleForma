...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auditor.date_begin'
        db.add_column('teleforma_auditor', 'date_begin',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 27, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Auditor.date_begin'
        db.delete_column('teleforma_auditor', 'date_begin')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 12, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.auditor': {
            ...
            'date_begin': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
