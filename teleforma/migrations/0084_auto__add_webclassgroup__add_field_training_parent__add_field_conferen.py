...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Training.parent'
        db.add_column('teleforma_training', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['teleforma.Training']),
                      keep_default=False)

        # Adding field 'Conference.web_class_group'
        db.add_column('teleforma_conference', 'web_class_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='conferences', null=True, on_delete=models.SET_NULL, to=orm['teleforma.WebClassGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Training.parent'
        db.delete_column('teleforma_training', 'parent_id')
