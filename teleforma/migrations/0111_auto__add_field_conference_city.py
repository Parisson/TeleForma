...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.city'
        db.add_column('teleforma_conference', 'city',
                      self.gf('telemeta.models.core.WeakForeignKey')(default=None, related_name='city', null=True, blank=True, to=orm['telemeta.Location']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Conference.city'
        db.delete_column('teleforma_conference', 'city_id')
