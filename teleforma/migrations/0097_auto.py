...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field docs_description on 'Seminar'
        db.create_table('teleforma_seminar_docs_description', (
        ...
        db.create_unique('teleforma_seminar_docs_description', ['seminar_id', 'document_id'])

    def backwards(self, orm):
        # Removing M2M table for field docs_description on 'Seminar'
        db.delete_table('teleforma_seminar_docs_description')
