...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.last_professor_sent'
        db.add_column('teleforma_course', 'last_professor_sent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teleforma.Professor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.last_professor_sent'
        db.delete_column('teleforma_course', 'last_professor_sent_id')
