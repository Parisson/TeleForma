...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conference.approved'
        db.add_column('teleforma_conference', 'approved',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conference.approved'
        db.delete_column('teleforma_conference', 'approved')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
