...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_auditor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='auditor', unique=True, to=orm['auth.User'])),
            ('platform_only', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('teleforma', ['Auditor'])

        # Adding M2M table for field seminars on 'Auditor'
        db.create_table('teleforma_auditor_seminars', (
        ...
        db.create_unique('teleforma_auditor_seminars', ['auditor_id', 'seminar_id'])

        # Adding field 'Seminar.magistral'
        db.add_column('teleforma_seminar', 'magistral',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teleforma_auditor')

        # Removing M2M table for field seminars on 'Auditor'
        db.delete_table('teleforma_auditor_seminars')

        # Deleting field 'Seminar.magistral'
        db.delete_column('teleforma_seminar', 'magistral')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
