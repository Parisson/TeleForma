...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.keywords_string'
        db.add_column('teleforma_seminar', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Seminar.site'
        db.add_column('teleforma_seminar', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Seminar.slug'
        db.add_column('teleforma_seminar', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seminar._meta_title'
        db.add_column('teleforma_seminar', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seminar.gen_description'
        db.add_column('teleforma_seminar', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Seminar.publish_date'
        db.add_column('teleforma_seminar', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seminar.expiry_date'
        db.add_column('teleforma_seminar', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Seminar.short_url'
        db.add_column('teleforma_seminar', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Seminar.title'
        db.alter_column('teleforma_seminar', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))
    def backwards(self, orm):
        # Deleting field 'Seminar.keywords_string'
        db.delete_column('teleforma_seminar', 'keywords_string')

        # Deleting field 'Seminar.site'
        db.delete_column('teleforma_seminar', 'site_id')

        # Deleting field 'Seminar.slug'
        db.delete_column('teleforma_seminar', 'slug')

        # Deleting field 'Seminar._meta_title'
        db.delete_column('teleforma_seminar', '_meta_title')

        # Deleting field 'Seminar.gen_description'
        db.delete_column('teleforma_seminar', 'gen_description')

        # Deleting field 'Seminar.publish_date'
        db.delete_column('teleforma_seminar', 'publish_date')

        # Deleting field 'Seminar.expiry_date'
        db.delete_column('teleforma_seminar', 'expiry_date')

        # Deleting field 'Seminar.short_url'
        db.delete_column('teleforma_seminar', 'short_url')


        # Changing field 'Seminar.title'
        db.alter_column('teleforma_seminar', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))
    models = {
        'auth.group': {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.documentsimple': {
            'Meta': {'ordering': "['rank']", 'object_name': 'DocumentSimple', 'db_table': "'teleforma_document_simple'"},
            'code': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'credits': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'date_added': ('telemeta.models.core.DateTimeField', [], {'default': 'None', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'date_modified': ('telemeta.models.core.DateTimeField', [], {'default': 'None', 'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
