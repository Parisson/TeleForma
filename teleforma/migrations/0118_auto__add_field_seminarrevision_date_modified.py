...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeminarRevision.date_modified'
        db.add_column('teleforma_seminar_revisions', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeminarRevision.date_modified'
        db.delete_column('teleforma_seminar_revisions', 'date_modified')
    ...
    models = {
        ...
        'teleforma.seminarrevision': {
            'Meta': {'ordering': "['date_modified', '-date']", 'object_name': 'SeminarRevision', 'db_table': "'teleforma_seminar_revisions'"},
