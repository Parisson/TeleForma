...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.rank'
        db.alter_column('teleforma_question', 'rank', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Question.rank'
        db.alter_column('teleforma_question', 'rank', self.gf('django.db.models.fields.IntegerField')(default=1))
    models = {
        'auth.group': {
