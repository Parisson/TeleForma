...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('teleforma_media', 'description')

        # Deleting field 'Media.title'
        db.delete_column('teleforma_media', 'title')
        ...
        # Adding field 'Conference.comment'
        db.add_column('teleforma_conference', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Media.description'
        db.add_column('teleforma_media', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Media.title'
        db.add_column('teleforma_media', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'Conference.comment'
        db.delete_column('teleforma_conference', 'comment')
