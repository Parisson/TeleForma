...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auditor.gender'
        db.add_column('teleforma_auditor', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True),
                      keep_default=False)

        # Adding field 'Auditor.status'
        db.add_column('teleforma_auditor', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Auditor.gender'
        db.delete_column('teleforma_auditor', 'gender')

        # Deleting field 'Auditor.status'
        db.delete_column('teleforma_auditor', 'status')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.seminar': {
            ...
            'media_previews': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'seminar_media_previews'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Media']"}),
