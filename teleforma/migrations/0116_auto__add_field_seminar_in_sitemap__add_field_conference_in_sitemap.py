...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.in_sitemap'
        db.add_column('teleforma_seminar', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Conference.in_sitemap'
        db.add_column('teleforma_conference', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Seminar.in_sitemap'
        db.delete_column('teleforma_seminar', 'in_sitemap')

        # Deleting field 'Conference.in_sitemap'
        db.delete_column('teleforma_conference', 'in_sitemap')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 5, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
