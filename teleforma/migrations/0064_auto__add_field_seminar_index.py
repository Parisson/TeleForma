...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.index'
        db.add_column('teleforma_seminar', 'index',
                      self.gf('tinymce.models.HTMLField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Seminar.index'
        db.delete_column('teleforma_seminar', 'index')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 22, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
