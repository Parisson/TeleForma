...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_payment', (
            ...
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment', to=orm['teleforma.Student'])),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('teleforma', ['Payment'])

        # Adding field 'Training.cost'
        db.add_column('teleforma_training', 'cost',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Training.cost'
        db.delete_column('teleforma_training', 'cost')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 4, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
