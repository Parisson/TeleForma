...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('exam_corrector', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='correctors', null=True, to=orm['auth.User'])),
        ))
        ...
        db.create_table('exam_quota', (
            ...
            ('corrector', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quotas', null=True, to=orm['exam.Corrector'])),
        ...
        db.create_table('exam_exam', (
            ...
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exams', null=True, on_delete=models.SET_NULL, to=orm['teleforma.Course'])),
            ('session', self.gf('django.db.models.fields.IntegerField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='exams', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
        ...
        db.create_table('exam_script', (
            ...
            ('mime_type', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('sha1', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scripts', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('exam', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scripts', null=True, on_delete=models.SET_NULL, to=orm['exam.Exam'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('box_uuid', self.gf('django.db.models.fields.CharField')(max_length='256', blank=True)),
            ('box_session_key', self.gf('django.db.models.fields.CharField')(max_length='1024', blank=True)),
            ('corrector', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scripts', null=True, on_delete=models.SET_NULL, to=orm['exam.Corrector'])),
            ('note', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=2, blank=True)),
            ('reject_reason', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('date_corrected', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'exam.script': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mime_type': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'note': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            'reject_reason': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'sha1': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
