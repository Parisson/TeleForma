...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Script.score'
        db.add_column('exam_script', 'score',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Exam.note'
        db.delete_column('exam_exam', 'note')

        # Adding field 'Exam.score'
        db.add_column('exam_exam', 'score',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Script.score'
        db.delete_column('exam_script', 'score')

        # Adding field 'Exam.note'
        db.add_column('exam_exam', 'note',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Exam.score'
        db.delete_column('exam_exam', 'score')
