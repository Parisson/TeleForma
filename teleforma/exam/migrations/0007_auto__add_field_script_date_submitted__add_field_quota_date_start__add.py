...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Script.date_submitted'
        db.add_column('exam_script', 'date_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Quota.date_start'
        db.add_column('exam_quota', 'date_start',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 22, 0, 0)),
                      keep_default=False)

        # Adding field 'Quota.date_end'
        db.add_column('exam_quota', 'date_end',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 5, 22, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('exam_script', 'date_submitted')

        # Deleting field 'Quota.date_start'
        db.delete_column('exam_quota', 'date_start')

        # Deleting field 'Quota.date_end'
        db.delete_column('exam_quota', 'date_end')
