...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exam.note'
        db.alter_column('exam_exam', 'note', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Exam.session'
        db.alter_column('exam_exam', 'session', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Exam.note'
        db.alter_column('exam_exam', 'note', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Exam.session'
        db.alter_column('exam_exam', 'session', self.gf('django.db.models.fields.IntegerField')(default=1))
