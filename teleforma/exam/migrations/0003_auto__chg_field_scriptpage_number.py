...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScriptPage.number'
        db.alter_column('exam_scriptpage', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ScriptPage.number'
        db.alter_column('exam_scriptpage', 'number', self.gf('django.db.models.fields.IntegerField')(default=0))
