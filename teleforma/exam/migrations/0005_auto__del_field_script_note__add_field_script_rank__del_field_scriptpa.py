...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Script.note'
        db.delete_column('exam_script', 'note')

        # Adding field 'Script.rank'
        db.add_column('exam_script', 'rank',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ScriptPage.number'
        db.delete_column('exam_scriptpage', 'number')

        # Adding field 'ScriptPage.rank'
        db.add_column('exam_scriptpage', 'rank',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Script.note'
        db.add_column('exam_script', 'note',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Script.rank'
        db.delete_column('exam_script', 'rank')

        # Adding field 'ScriptPage.number'
        db.add_column('exam_scriptpage', 'number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ScriptPage.rank'
        db.delete_column('exam_scriptpage', 'rank')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 5, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
