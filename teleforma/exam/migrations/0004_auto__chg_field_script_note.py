...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Script.note'
        db.alter_column('exam_script', 'note', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Script.note'
        db.alter_column('exam_script', 'note', self.gf('django.db.models.fields.FloatField')(default=0))
