...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field periods on 'Document'

        m2m_table_name = db.shorten_name('teleforma_document_periods')
        ...
        db.create_unique(m2m_table_name, ['document_id', 'period_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field periods on 'Document'
        db.delete_table(db.shorten_name('teleforma_document_periods'))
