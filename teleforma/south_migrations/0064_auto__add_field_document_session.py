...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.session'
        db.add_column('teleforma_document', 'session',
                      self.gf('telemeta.models.core.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.session'
        db.delete_column('teleforma_document', 'session')
    ...
    models = {
        ...
        'teleforma.document': {
            ...
            'session': ('telemeta.models.core.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'title': ('telemeta.models.core.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
