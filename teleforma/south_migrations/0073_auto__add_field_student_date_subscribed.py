...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.date_subscribed'
        db.add_column('teleforma_student', 'date_subscribed',
                      self.gf('telemeta.models.core.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.date_subscribed'
        db.delete_column('teleforma_student', 'date_subscribed')
    ...
    models = {
        ...
        'teleforma.student': {
            ...
            'date_subscribed': ('telemeta.models.core.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
