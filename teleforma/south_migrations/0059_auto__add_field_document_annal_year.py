...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.annal_year'
        db.add_column('teleforma_document', 'annal_year',
                      self.gf('telemeta.models.core.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.annal_year'
        db.delete_column('teleforma_document', 'annal_year')
