...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Payback'
        db.create_table('teleforma_paybacks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='paybacks', to=orm['teleforma.Student'])),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('teleforma', ['Payback'])


    def backwards(self, orm):
        # Deleting model 'Payback'
        db.delete_table('teleforma_paybacks')
