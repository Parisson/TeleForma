...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field quiz on 'Course'
        m2m_table_name = db.shorten_name('teleforma_course_quiz')
        ...
        db.create_unique(m2m_table_name, ['course_id', 'quiz_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field quiz on 'Course'
        db.delete_table(db.shorten_name('teleforma_course_quiz'))
