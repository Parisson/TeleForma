...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Period.date_end'
        db.alter_column('teleforma_period', 'date_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Period.date_begin'
        db.alter_column('teleforma_period', 'date_begin', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Period.date_end'
        db.alter_column('teleforma_period', 'date_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Period.date_begin'
        db.alter_column('teleforma_period', 'date_begin', self.gf('django.db.models.fields.DateTimeField')(null=True))
