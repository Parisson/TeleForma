...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field synthesis_note on 'Student'
        db.create_table('teleforma_student_synthesis_note', (
        ...
        db.create_unique('teleforma_student_synthesis_note', ['student_id', 'course_id'])

        # Adding M2M table for field obligation on 'Student'
        db.create_table('teleforma_student_obligation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm['teleforma.student'], null=False)),
            ('course', models.ForeignKey(orm['teleforma.course'], null=False))
        ))
        db.create_unique('teleforma_student_obligation', ['student_id', 'course_id'])

    def backwards(self, orm):
        # Removing M2M table for field synthesis_note on 'Student'
        db.delete_table('teleforma_student_synthesis_note')

        # Removing M2M table for field obligation on 'Student'
        db.delete_table('teleforma_student_obligation')
