...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Professor.training'
        db.delete_column('teleforma_professor', 'training_id')
    ...
    def backwards(self, orm):
        # Adding field 'Professor.training'
        db.add_column('teleforma_professor', 'training',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='professor', null=True, to=orm['teleforma.Training'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Student.period'
        db.add_column('teleforma_student', 'period',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='student', null=True, to=orm['teleforma.Period'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.course': {
            'Meta': {'ordering': "['-date_modified']", 'object_name': 'Course'},
