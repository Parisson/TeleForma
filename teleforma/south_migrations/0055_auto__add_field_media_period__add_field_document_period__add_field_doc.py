...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teleforma_conference', 'period',
                      self.gf('telemeta.models.core.ForeignKey')(related_name='conference', on_delete=models.SET_NULL, default=None, to=orm['teleforma.Period'], blank=True, null=True),
                      keep_default=False)
