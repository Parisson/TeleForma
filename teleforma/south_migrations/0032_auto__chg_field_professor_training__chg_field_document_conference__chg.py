...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Professor.training'
        db.alter_column('teleforma_professor', 'training_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['teleforma.Training']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Professor.training'
        db.alter_column('teleforma_professor', 'training_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.Training']))

        # Changing field 'Document.conference'
        db.alter_column('teleforma_document', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.Conference']))
        ...
        # Changing field 'Media.conference'
        db.alter_column('teleforma_media', 'conference_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['teleforma.Conference']))

        # Changing field 'Conference.professor'
        db.alter_column('teleforma_conference', 'professor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teleforma.Professor']))
    models = {
        'auth.group': {
        ...
        'teleforma.professor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'training': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'professor'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['teleforma.Training']"}),
