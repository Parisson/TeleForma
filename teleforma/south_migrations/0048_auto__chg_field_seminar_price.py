...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seminar.price'
        db.alter_column('teleforma_seminar', 'price', self.gf('django.db.models.fields.FloatField')(null=True))
    def backwards(self, orm):

        # Changing field 'Seminar.price'
        db.alter_column('teleforma_seminar', 'price', self.gf('django.db.models.fields.FloatField')(default=1))
    models = {
        'auth.group': {
