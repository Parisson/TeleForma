...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.title_tweeter'
        db.add_column('teleforma_course', 'title_tweeter',
                      self.gf('telemeta.models.core.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Course.title_tweeter'
        db.delete_column('teleforma_course', 'title_tweeter')
