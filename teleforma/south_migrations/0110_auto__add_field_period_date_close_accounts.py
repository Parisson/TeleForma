...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Period.date_close_accounts'
        db.add_column('teleforma_period', 'date_close_accounts',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Period.date_close_accounts'
        db.delete_column('teleforma_period', 'date_close_accounts')
