...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.type'
        db.add_column('teleforma_payments', 'type',
                      self.gf('django.db.models.fields.CharField')(default='check', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.type'
        db.delete_column('teleforma_payments', 'type')
