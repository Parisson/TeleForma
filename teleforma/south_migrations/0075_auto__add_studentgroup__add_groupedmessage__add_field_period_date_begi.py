...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_student_groups', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('teleforma', ['StudentGroup'])

        # Adding M2M table for field students on 'StudentGroup'
        m2m_table_name = db.shorten_name('teleforma_student_groups_students')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studentgroup', models.ForeignKey(orm['teleforma.studentgroup'], null=False)),
        ...
        db.create_table('teleforma_grouped_messages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='grouped_messages', null=True, on_delete=models.SET_NULL, to=orm['teleforma.StudentGroup'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='grouped_messages', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=119)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('to_send', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_sent', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('teleforma', ['GroupedMessage'])

        # Adding field 'Period.date_begin'
        db.add_column('teleforma_period', 'date_begin',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Period.date_end'
        db.add_column('teleforma_period', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teleforma_student_groups')

        # Removing M2M table for field students on 'StudentGroup'
        db.delete_table(db.shorten_name('teleforma_student_groups_students'))

        # Deleting model 'GroupedMessage'
        db.delete_table('teleforma_grouped_messages')

        # Deleting field 'Period.date_begin'
        db.delete_column('teleforma_period', 'date_begin')

        # Deleting field 'Period.date_end'
        db.delete_column('teleforma_period', 'date_end')
