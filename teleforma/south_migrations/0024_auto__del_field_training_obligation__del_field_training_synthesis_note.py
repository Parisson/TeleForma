...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Training.obligation'
        db.delete_column('teleforma_training', 'obligation')

        # Deleting field 'Training.synthesis_note'
        db.delete_column('teleforma_training', 'synthesis_note')

        # Adding M2M table for field synthesis_note on 'Training'
        db.create_table('teleforma_training_synthesis_note', (
        ...
        db.create_unique('teleforma_training_synthesis_note', ['training_id', 'coursetype_id'])

        # Adding M2M table for field obligation on 'Training'
        db.create_table('teleforma_training_obligation', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_obligation', ['training_id', 'coursetype_id'])

        # Adding M2M table for field procedure on 'Training'
        db.create_table('teleforma_training_procedure', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_procedure', ['training_id', 'coursetype_id'])

        # Adding M2M table for field written_speciality on 'Training'
        db.create_table('teleforma_training_written_speciality', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_written_speciality', ['training_id', 'coursetype_id'])

        # Adding M2M table for field oral_speciality on 'Training'
        db.create_table('teleforma_training_oral_speciality', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_oral_speciality', ['training_id', 'coursetype_id'])

        # Adding M2M table for field oral_1 on 'Training'
        db.create_table('teleforma_training_oral_1', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_oral_1', ['training_id', 'coursetype_id'])

        # Adding M2M table for field oral_2 on 'Training'
        db.create_table('teleforma_training_oral_2', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_oral_2', ['training_id', 'coursetype_id'])

        # Adding M2M table for field options on 'Training'
        db.create_table('teleforma_training_options', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('training', models.ForeignKey(orm['teleforma.training'], null=False)),
            ('coursetype', models.ForeignKey(orm['teleforma.coursetype'], null=False))
        ))
        db.create_unique('teleforma_training_options', ['training_id', 'coursetype_id'])

        # Deleting field 'Student.network_only'
        db.delete_column('teleforma_student', 'network_only')

        # Adding field 'Student.platform_only'
        db.add_column('teleforma_student', 'platform_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Training.obligation'
        db.add_column('teleforma_training', 'obligation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Training.synthesis_note'
        db.add_column('teleforma_training', 'synthesis_note',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing M2M table for field synthesis_note on 'Training'
        db.delete_table('teleforma_training_synthesis_note')

        # Removing M2M table for field obligation on 'Training'
        db.delete_table('teleforma_training_obligation')

        # Removing M2M table for field procedure on 'Training'
        db.delete_table('teleforma_training_procedure')

        # Removing M2M table for field written_speciality on 'Training'
        db.delete_table('teleforma_training_written_speciality')

        # Removing M2M table for field oral_speciality on 'Training'
        db.delete_table('teleforma_training_oral_speciality')

        # Removing M2M table for field oral_1 on 'Training'
        db.delete_table('teleforma_training_oral_1')

        # Removing M2M table for field oral_2 on 'Training'
        db.delete_table('teleforma_training_oral_2')

        # Removing M2M table for field options on 'Training'
        db.delete_table('teleforma_training_options')

        # Adding field 'Student.network_only'
        db.add_column('teleforma_student', 'network_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Student.platform_only'
        db.delete_column('teleforma_student', 'platform_only')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.course': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'course'", 'null': 'True', 'to': "orm['teleforma.CourseType']"})
        },
        ...
        'teleforma.student': {
            ...
            'obligation': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'student_obligation'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Course']"}),
            'options': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'student_options'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Course']"}),
            ...
            'synthesis_note': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'student_synthesis_note'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['teleforma.Course']"}),
