...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_payments', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments', to=orm['teleforma.Student'])),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('month', self.gf('django.db.models.fields.IntegerField')(default=1)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('teleforma_payments')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'teleforma.payment': {
            'Meta': {'object_name': 'Payment', 'db_table': "'teleforma_payments'"},
