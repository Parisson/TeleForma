...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seminar.concerned'
        db.add_column('teleforma_seminar', 'concerned',
    ...
    def backwards(self, orm):
        # Deleting field 'Seminar.concerned'
        db.delete_column('teleforma_seminar', 'concerned')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 10, 31, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
