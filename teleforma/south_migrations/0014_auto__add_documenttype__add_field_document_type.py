...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teleforma_document_type', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('teleforma', ['DocumentType'])

        # Adding field 'Document.type'
        db.add_column('teleforma_document', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='document', null=True, to=orm['teleforma.DocumentType']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'DocumentType'
        db.delete_table('teleforma_document_type')

        # Deleting field 'Document.type'
        db.delete_column('teleforma_document', 'type_id')
    ...
    models = {
        ...
        'notes.note': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 7, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
